...
data = pd.read_csv('C:/Users/dell/Desktop/Data mining/training.csv')
...
predict=knc_random.predict(test)
prediction = pd.DataFrame(predict, columns=['predictions']).to_csv('KNN_prediction.csv',index=False)
